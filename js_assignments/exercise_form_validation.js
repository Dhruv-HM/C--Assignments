...
function NumberValidate(){
    ...
    if(namePattern.test(number)){
        ...
        document.getElementById("number").innerText='Nice name bro!';
        nameStatus=true;
        fieldStatus=true;
        obj.number=number;
        ...
        document.getElementById("number").innerText='Not a valid name bro!';
        nameStatus=false;
        fieldStatus=false;
    }
...
function PasswordValidate(){
    ...
    if(pass.localeCompare(repass)){
        ...
        document.getElementById("repass").innerText='Everything Looks Good';
        passStatus=true;
        fieldStatus=true;
        obj.password="can't show";
    }

    else{
        document.getElementById('repass').style.color="red";
        document.getElementById("repass").innerText='Password do not match my master :(';
        passStatus=false;
        fieldStatus=false;
    }
